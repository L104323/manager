    ...
    <div>
        <div class="container">
            ...
            >
                ...
                <el-table-column prop="garbageName" label="垃圾名称" align="center"></el-table-column>
                <el-table-column label="垃圾分类" prop="garbageType" align="center">
                </el-table-column>
                <el-table-column label="标识图" align="center">
                    <template slot-scope="scope">
                        <el-image
                            class="table-td-thumb"
                            :src="imgBaseUrl+scope.row.typeImg"
                            :preview-src-list="[imgBaseUrl+scope.row.typeImg]"
                        ></el-image>
                    </template>
                </el-table-column>
